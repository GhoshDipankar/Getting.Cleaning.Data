...
#
# Reading of 6 activity labels and corresponding names like "Walking", "Standing" etc:    
...
# Data for all the activities for all measurements performed by all Test Subject IDs:
...
# Data for all the activities for all measurements performed by all Training Subject IDs:  
  x_train <- read.table("UCI HAR Dataset/train/X_train.txt")
#
# % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
# 2. Preparation of combined data from Test and Training Data Sets:
#
# Combining Test and Training Subject IDs:  
  subject <- rbind(subject_test, subject_train)
# Adding Column Name as "SubjectID"  
  names(subject) <- "SubjectID"
# Combining List of Activity Labels from Test and Training Sets:
  activity <- rbind(activity_test, activity_train)
# Adding Column Name as "Activity"  
  names(activity) <- "Activity"
# Combining of all the activities for all measurements performed by 
...
# 5. Giving descriptive activity names to name the activities in the data set:
  selectedData$Activity <- factor(selectedData$Activity, labels = activity_labels[,2])
#
# % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
